...
namespace Saturland
{
    public partial class BookWTPKiddie : Form
    {
        public BookWTPKiddie()
        {
            InitializeComponent();
        ...
        private void Numeric_Kids_ValueChanged(object sender, EventArgs e)
        {
            ...
            int kids_subtotal = (numkids * 590);
            int kids_discount = (numkids * (590 - 390));
            int kids_total = kids_subtotal - kids_discount;

            int adults_subtotal = (numadults * 490);
            int adults_discount = (numadults * (490 - 290));
        ...
        private void Button_Really_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                string mainconn = ConfigurationManager.ConnectionStrings["Mysqlconnection"].ConnectionString;
                MySqlConnection sqlconn = new MySqlConnection(mainconn);
                MySqlDataAdapter da = new MySqlDataAdapter("SELECT * FROM kiddiecove WHERE Fname = '" + TextBox_Fname.Text + "' AND Lname = '" + TextBox_Lname.Text + "'", sqlconn);
                ...
                if (TextBox_IDsearch.Text == "")
                {
                    ...
                    else
                    {
                        ...
                        catch (Exception ex)
                        {
                            ...
                            PaymentWTPKids paymentWTPKids = new PaymentWTPKids();
                            paymentWTPKids.Show();
        ...
        private void Button_View_Click(object sender, EventArgs e)
        {
            ...
            if (ComboBox_SeclectVisa.SelectedItem.ToString() == "Highway Visa Card")
            {
                ...
                if (da.Read())
                {
                    ...
                    double kids_subtotal = (numkids * 590);
                    double kids_discount = (numkids * (590 - 390));
                    double kids_total = kids_subtotal - kids_discount;

                    double adults_subtotal = (numadults * 490);
                    double adults_discount = (numadults * (490 - 290));
                ...
                else
                {
                    ...
                    double adults_subtotal = (numparents * 490);
                    double adults_discount = (numparents * (490 - 290));
                    double adults_total = adults_subtotal - adults_discount;
