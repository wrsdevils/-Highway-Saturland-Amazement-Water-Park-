...
namespace Saturland
{
    public partial class PaymentAMZAdventure : Form
    {
        public PaymentAMZAdventure()
        {
            InitializeComponent();
        }
        string imgLocation = "";

        private void PaymentAMZAdventure_Load(object sender, EventArgs e)
        {
        ...
        private void Button_UploadeFile_Click_1(object sender, EventArgs e)
        {
        ...
        private void Button_CheckOut_Click_1(object sender, EventArgs e)
        {
            ...
            MySqlDataAdapter da = new MySqlDataAdapter("SELECT * FROM adventurezone WHERE Fname = '" + label9.Text + "' ", sqlconn);
            ...
            if (dt.Rows.Count == 1)
            {
                ...
                string updateQuery = "UPDATE adventurezone SET imgPaid = @images WHERE Fname = '" + label9.Text + "' ";
