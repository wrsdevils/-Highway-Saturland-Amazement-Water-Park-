...
namespace Saturland
{
    public partial class PaymentAMZKids : Form
    {
        public PaymentAMZKids()
        {
            InitializeComponent();
        }
        string imgLocation = "";
        private void PaymentAMZKids_Load(object sender, EventArgs e)
        {
            Label_KidsAmount.Text = GlobalPayment.First;
            Label_ParentsAmount.Text = GlobalPayment.Second;
        ...
        private void Button_CheckOut_Click(object sender, EventArgs e)
        {
            ...
            MySqlDataAdapter da = new MySqlDataAdapter("SELECT * FROM kidsfunny WHERE Fname = '" + label9.Text + "' ", sqlconn);
            ...
            if (dt.Rows.Count == 1)
            {
                ...
                string updateQuery = "UPDATE kidsfunny SET imgPaid = @images WHERE Fname = '" + label9.Text + "' ";
