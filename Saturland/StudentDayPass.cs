...
namespace Saturland
{
    public partial class StudentDayPass : Form
    {
        public StudentDayPass()
        {
            InitializeComponent();
        ...
        private void StudentDayPass_Load(object sender, EventArgs e)
        {
        ...
        private void TextBox_Fanme_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        {
            if (TextBox_IDcard.Text != "" && TextBox_Fname.Text !="" && TextBox_Lname.Text !="" && dateTimePicker_Birth.Text !="" && ComboBox_District.Text != "" && TextBox_Email.Text !="" && TextBox_Telnum.Text !="")
            {
        ...
        private void ComboBox_SubDistrict_SelectedIndexChanged(object sender, EventArgs e)
        {
            ComboBox_PostCode.Items.Clear();
            //ComboBox_District.Items.Add(ComboBox_Province.Text);
            string mainconn = ConfigurationManager.ConnectionStrings["Mysqlconnection"].ConnectionString;
        ...
        private void Button_Really_Click_1(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                string mainconn = ConfigurationManager.ConnectionStrings["Mysqlconnection"].ConnectionString;
                MySqlConnection sqlconn = new MySqlConnection(mainconn);
                MySqlDataAdapter da = new MySqlDataAdapter("SELECT * FROM studentsdayregis WHERE IDCard = '" + TextBox_IDcard.Text + "'", sqlconn);
                ...
                {
                    string message = "Sorry this promotion is not available now! ";
                    ...
                    else
                    {
                        ...
                        /*
                        sqlconn.Open();
                        MySqlCommand command = new MySqlCommand("INSERT INTO `studentsdayregis`(`IDCard`, `Fname`, `Lname`, `Birth`, `Email`, `Tel`,`Address`, `Province`, `District`, `SubDistrict`, `PostCode`, `date`) VALUES('" + TextBox_IDcard.Text + "','" + TextBox_Fname.Text + "','" + TextBox_Lname.Text + "','" + dateTimePicker_Birth.Value.ToString("dd-MMM-yyyy") + "','" + TextBox_Email.Text + "','" + TextBox_Telnum.Text + "','" + TextBox_Address.Text + "','" + ComboBox_Province.Text + "','" + ComboBox_District.Text + "','" + ComboBox_SubDistrict.Text + "','" + ComboBox_PostCode.Text + "','" + DateTime.Now + "')", sqlconn);
        ...
        private void TextBox_Lname_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            if (((int)e.KeyChar >= 65 && (int)e.KeyChar <= 122)
                || (int)e.KeyChar == 8
                || (int)e.KeyChar == 13
        ...
        private void pictureBox_Leftback_Click_1(object sender, EventArgs e)
        {
            this.Hide();
            Main main = new Main();
            main.Show();
