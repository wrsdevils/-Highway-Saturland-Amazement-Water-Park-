...
namespace Saturland
{
    public partial class PaymentWTPAdults : Form
    {
        public PaymentWTPAdults()
        {
            InitializeComponent();
        }
        string imgLocation = "";
        ...
        private void Button_CheckOut_Click(object sender, EventArgs e)
        {
            ...
            MySqlDataAdapter da = new MySqlDataAdapter("SELECT * FROM adultaqau WHERE Fname = '" + label9.Text + "' ", sqlconn);
            ...
            if (dt.Rows.Count == 1)
            {
                ...
                string updateQuery = "UPDATE adultaqau SET imgPaid = @images WHERE Fname = '" + label9.Text + "' ";
        ...
        private void PaymentWTPAdults_Load(object sender, EventArgs e)
        {
