...
namespace Saturland
{
    public partial class PaymentAMZAdults : Form
    {
        public PaymentAMZAdults()
        {
            InitializeComponent();
        }
        string imgLocation = "";
        private void PaymentAMZAdults_Load(object sender, EventArgs e)
        {
        ...
        private void Button_CheckOut_Click(object sender, EventArgs e)
        {
            ...
            MySqlDataAdapter da = new MySqlDataAdapter("SELECT * FROM adultsland WHERE Fname = '" + label9.Text + "' ", sqlconn);
            ...
            if (dt.Rows.Count == 1)
            {
                ...
                string updateQuery = "UPDATE adultsland SET imgPaid = @images WHERE Fname = '" + label9.Text + "' ";
