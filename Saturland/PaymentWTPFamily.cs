...
namespace Saturland
{
    public partial class PaymentWTPFamily : Form
    {
        public PaymentWTPFamily()
        {
            InitializeComponent();
        }
        string imgLocation = "";
        ...
        private void Button_CheckOut_Click(object sender, EventArgs e)
        {
            ...
            MySqlDataAdapter da = new MySqlDataAdapter("SELECT * FROM familyzone WHERE Fname = '" + label9.Text + "' ", sqlconn);
            ...
            if (dt.Rows.Count == 1)
            {
                ...
                string updateQuery = "UPDATE familyzone SET imgPaid = @images WHERE Fname = '" + label9.Text + "' ";
        ...
        private void PaymentWTPFamily_Load(object sender, EventArgs e)
        {
