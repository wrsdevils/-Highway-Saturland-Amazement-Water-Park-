...
namespace Saturland
{
    public partial class BookWTPAdult : Form
    {
        public BookWTPAdult()
        {
            InitializeComponent();
        ...
        private void Numeric_Kids_ValueChanged(object sender, EventArgs e)
        {
            ...
            int adults_subtotal = (numadults * 790);
            int adults_discount = (numadults * (790 - 590));
        ...
        private void Button_Really_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                string mainconn = ConfigurationManager.ConnectionStrings["Mysqlconnection"].ConnectionString;
                MySqlConnection sqlconn = new MySqlConnection(mainconn);
                MySqlDataAdapter da = new MySqlDataAdapter("SELECT * FROM adultaqau WHERE Fname = '" + TextBox_Fname.Text + "' AND Lname = '" + TextBox_Lname.Text + "'", sqlconn);
                ...
                if (TextBox_IDsearch.Text == "")
                {
                    ...
                    else
                    {
                        ...
                        catch (Exception ex)
                        {
                            ...
                            PaymentWTPAdults paymentWTPAdults = new PaymentWTPAdults();
                            paymentWTPAdults.Show();
        ...
        private void Button_View_Click(object sender, EventArgs e)
        {
            ...
            if (ComboBox_SeclectVisa.SelectedItem.ToString() == "Highway Visa Card")
            {
                ...
                if (da.Read())
                {
                    ...
                    double adults_subtotal = (numadults * 790);
                    double adults_discount = (numadults * (790 - 590));
