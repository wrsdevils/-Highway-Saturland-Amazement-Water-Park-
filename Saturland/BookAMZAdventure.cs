...
namespace Saturland
{
    public partial class BookAMZAdventure : Form
    {
        public BookAMZAdventure()
        {
            InitializeComponent();
        ...
        private void Numeric_Kids_ValueChanged(object sender, EventArgs e)
        {
            ...
            int adults_subtotal = (numadults * 1190);
            int adults_discount = (numadults * (1190 - 990));
        ...
        private void Button_Really_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                string mainconn = ConfigurationManager.ConnectionStrings["Mysqlconnection"].ConnectionString;
                MySqlConnection sqlconn = new MySqlConnection(mainconn);
                MySqlDataAdapter da = new MySqlDataAdapter("SELECT * FROM adventurezone WHERE Fname = '" + TextBox_Fname.Text + "' AND Lname = '" + TextBox_Lname.Text + "'", sqlconn);
                ...
                if (TextBox_IDsearch.Text == "")
                {
                    ...
                    else
                    {
                        ...
                        catch (Exception ex)
                        {
                            ...
                            PaymentAMZAdventure paymentAMZAdventure = new PaymentAMZAdventure();
                            paymentAMZAdventure.Show();
        ...
        private void Button_View_Click(object sender, EventArgs e)
        {
            ...
            if (ComboBox_SeclectVisa.SelectedItem.ToString() == "Highway Visa Card")
            {
                ...
                if (da.Read())
                {
                    ...
                    double adults_subtotal = (numadults * 1190);
                    double adults_discount = (numadults * (1190 - 990));
                ...
                else
                {
                    ...
                    double adults_subtotal = (numparents * 1190);
                    double adults_discount = (numparents * (1190 - 990));
                    double adults_total = adults_subtotal - adults_discount;
